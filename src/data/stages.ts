export type StageDifficulty = 'basic' | 'normal' | 'advanced'
...
export const stages: StageDefinition[] = [
  ...
  { number: 4, puzzleId: 'p3', x: 68, y: 58, difficulty: 'advanced', difficultyLabel: '심화' },
  { number: 5, puzzleId: 'p5', x: 85, y: 47, difficulty: 'advanced', difficultyLabel: '심화' },
]
